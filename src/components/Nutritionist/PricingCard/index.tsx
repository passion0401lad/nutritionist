  ...
  return (
    <div className="justify-between flex p-[30px] flex-col items-start gap-[24px] self-stretch rounded-[10px] border-[1px] border-solid border-[#EEF8D3] bg-[#F6FBE9] sm:self-auto sm:flex-1 sm:p-[40px] sm:gap-[30px] md:p-[50px] md:gap-[40px] rounded-[12px]">
        ...
        <div className="flex flex-col items-start gap-[24px] self-stretch md:gap-[33px]">
            <div className="flex justify-center items-center gap-[2px] md:gap-[4px] flex-wrap">
                <h1 className="text-[#2C5446] font-Urbanist text-[40px] not-italic font-bold leading-[87.5%] sm:text-[36px] min-[800px]:text-[40px] md:text-[50px]">{props.salary}</h1>
                <p className="text-[#333] font-Urbanist text-[16px] not-italic font-medium leading-[150%] md:text-[18px]">/month</p>
            </div>
            <button className="text-[#262626] font-Urbanist text-[14px] not-italic font-semibold leading-normal md:text-[18px] flex px-[24px] py-[14px] justify-center items-center gap-[10px] self-stretch rounded-[6px] bg-[#CBEA7B] sm:px-[12px] min-[950px]:px-[24px] md:px-[41px] md:py-[18px] rounded-[8px]">Choose Plan</button>
        </div>
    </div>
  );
};
